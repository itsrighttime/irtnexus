CREATE TABLE IF NOT EXISTS history_user_phones (
    ...
    FOREIGN KEY (phone_id) REFERENCES user_phones(phone_id) ON DELETE CASCADE,
    INDEX idx_phone_time (tenant_id, phone_id, timestamp)
);