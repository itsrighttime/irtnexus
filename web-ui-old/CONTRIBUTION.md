...
Welcome to the **itsRIGHTtime** Project! This guide will walk you through the steps to set up and contribute to the project. Make sure to read the instructions carefully and follow the **Contributing Guidelines**.
...
- **Clone the entire repository** (with all branches):  
  ...
  ```bash
  git clone https://github.com/itsrighttime/<repo-name>.git
  cd <repo-name>
  ```
...
- **Clone only the `development` branch**:  
  ...
  ```bash
  git clone --single-branch --branch development https://github.com/itsrighttime/<repo-name>.git
  ```
